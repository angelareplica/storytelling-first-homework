...
(function () {
  ...
  var yPositionScale = d3.scalePoint().domain(['cat', 'cow', 'dog']).range([height, 0]).padding(0.5);
  ...
  function ready(datapoints) {
    ...
    }).attr('fill', '#FEBCC9').attr('opacity', 0.8);
...
//# sourceMappingURL=storytelling-first-homework/11-chart.252db17e.map