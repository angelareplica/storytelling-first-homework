...
(function () {
  ...
  var radiusScale = d3.scaleLinear().domain([0, 10]).range([0, 50]);

  var colorScale = d3.scaleOrdinal().range(['orange', 'purple', 'blue']);

  // Add your circles and style them here

  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('fill', function (d) {
    return colorScale(d.animal);
  }).attr('opacity', 0.5).attr('r', function (d) {
...
//# sourceMappingURL=storytelling-first-homework/05-chart.31e07d65.map