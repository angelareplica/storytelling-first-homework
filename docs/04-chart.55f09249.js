...
(function () {
  ...
  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('fill', '#FEBCC9').attr('r', 15).attr('cx', function (d) {
...
//# sourceMappingURL=storytelling-first-homework/04-chart.55f09249.map