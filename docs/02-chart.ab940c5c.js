...
(function () {
  ...
  var colorScale = d3.scaleOrdinal().domain(['North America', 'Europe', 'Antarctica']).range(['#feebe2', '#fbb4b9', '#f768a1']);
  ...
  svg.selectAll('rect').data(countries).attr('height', height).attr('width', function (d) {
...
//# sourceMappingURL=storytelling-first-homework/02-chart.ab940c5c.map