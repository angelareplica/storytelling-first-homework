...
(function () {
  ...
  var xPositionScale = d3.scalePoint().domain([0, 1, 2, 3])
  ...
  svg.selectAll('circle').data(data).attr('cx', function (d, i) {
...
//# sourceMappingURL=storytelling-first-homework/08-chart.6a91b109.map