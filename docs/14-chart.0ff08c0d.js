...
(function () {
  ...
  var colorScale = d3.scaleOrdinal().range(['#FF6F91', '#FF9671', '#FFC75F']);
  ...
  function ready(datapoints) {
    ...
    svg.selectAll('rect').data(datapoints).enter().append('rect').attr('height', function (d) {
      return heightScale(d.hamburgers);
    }).attr('fill', function (d) {
      return colorScale(d.animal);
    }).attr('width', xPositionScale.bandwidth()).attr('y', function (d) {
...
//# sourceMappingURL=storytelling-first-homework/14-chart.0ff08c0d.map