...
(function () {
  ...
  var xPositionScale = d3.scalePoint().domain(['Panda', 'Cat', 'Horse', 'Pig']).range([0, 400]);

  var radiusScale = d3.scaleSqrt().domain([0, 1000]).range([0, 50]);

  // Set your attributes here

  svg.selectAll('circle').data(datapoints).attr('cx', function (d) {
...
//# sourceMappingURL=storytelling-first-homework/03-chart.7e2b4db7.map